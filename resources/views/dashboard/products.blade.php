  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>هل بالفعل تريد حذف هذاالسجل؟!!</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">إلغاءالأمر</button>
...
<div class="container">
    <div class="row mt-5">
        <div class="col"><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addproducts">اضافة</button> 
        </div>
